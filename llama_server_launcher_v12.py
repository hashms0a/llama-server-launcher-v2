...
class LlamaServerLauncher:
    ...
    def build_top_bar(self, parent):
        ...
        top_frame = tk.Frame(parent, bg="#a3a29e", padx=5, pady=5)
        top_frame.pack(fill=tk.X)

        # --- Row 1: Run Mode + Control Buttons ---
        row1 = tk.Frame(top_frame, bg="#a3a29e")
        row1.pack(fill=tk.X)

        # Run Mode
        mode_frame = tk.LabelFrame(row1, text="Run Mode", bg="#a3a29e", padx=5, pady=5)
        mode_frame.pack(side=tk.LEFT, padx=(0, 10))

        tk.Radiobutton(mode_frame, text="Run in Terminal", variable=self.run_in_terminal_var, value=True, bg="#a3a29e").pack(side=tk.LEFT)
        tk.Radiobutton(mode_frame, text="Run in Background", variable=self.run_in_terminal_var, value=False, bg="#a3a29e").pack(side=tk.LEFT, padx=(10, 0))
        ...
        self.launch_btn = tk.Button(
            ...
            relief=tk.RAISED, padx=10, pady=2, cursor="hand2", font=("TkDefaultFont", 9, "bold")
        )
        ...
        self.status_label = ttk.Label(top_frame, textvariable=self.status_var, relief=tk.SUNKEN, anchor=tk.W)
